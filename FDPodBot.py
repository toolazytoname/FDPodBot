...
def lint():
    ...
    for repo_directory in repo_directory_list:
        ...
        lint_shell_command_list.append(
            'cd ' + repo_directory + ';git pull;' + checkout_command + "git log;pod lib lint --sources='http://gitlab.bitautotech.com/WP/Mobile/IOS/Specs.git,https://github.com/CocoaPods/Specs.git' --allow-warnings --use-libraries;")
